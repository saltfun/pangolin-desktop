        ...
        body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(
            ...
            child: new ListView(shrinkWrap: true, children: <Widget>[
              ...
              Text(
                  'You are on the latest version of DahliaOS, powered by Linux. This is a pre-release, and not indicative of the final product. If you run into bugs, feel free to create an issue report on Github, Reddit, or Discord.',
                  style: TextStyle(fontSize: 15, color: Color(0xff000000))),
              Text(
                  'Thank you to all of our supporters and developers for making this build possible.',
                  style: TextStyle(fontSize: 15, color: Color(0xff000000))),
            ]),
          ),
        ]));
